...
public class DialogAttachment extends Dialog {
    ...
    @BindView(R.id.lyr_message)
    LinearLayout lyrMessage;



    public DialogAttachment(Context mContext, AttachmentDialogResponse dialogResponseListener) {
        super(mContext);
    ...
    @OnClick({R.id.lyr_picturs, R.id.lyr_contacts, R.id.lyr_notes, R.id.lyr_camera, R.id.lyr_message, R.id.buttonCancel})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.lyr_message:
                dialogResponseListener.sharemsgfromvault();
                dismiss();
                break;
