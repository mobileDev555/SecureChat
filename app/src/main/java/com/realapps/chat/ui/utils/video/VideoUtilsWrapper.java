...
package com.realapps.chat.ui.utils.video;
    ...
    public static VideoUtilsWrapper getInstance() {
        if (instance == null) {
            if (Compatibility.isCompatible(5)) {
                instance = new com.realapps.chat.ui.utils.video.VideoUtils5();
            } else {
                instance = new com.realapps.chat.ui.utils.video.VideoUtils3();
            }
        }
