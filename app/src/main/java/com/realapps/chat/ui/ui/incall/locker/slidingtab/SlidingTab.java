...
package com.realapps.chat.ui.ui.incall.locker.slidingtab;
...
import com.realapps.chat.ui.ui.incall.locker.LeftRightChooserUtils;
import com.realapps.chat.ui.ui.incall.locker.IOnLeftRightChoice.IOnLeftRightProvider;
import com.realapps.chat.ui.ui.incall.locker.IOnLeftRightChoice.TypeOfLock;
import com.realapps.chat.ui.ui.incall.locker.multiwaveview.GlowPadView.OnTriggerListener;
...
public class SlidingTab extends ViewGroup implements IOnLeftRightProvider {
	...
	private static class Slider {
		...
		Slider(ViewGroup parent, int iconId, int targetId, int barId, int tabId) {
			...
			if(!parent.isInEditMode()) {
			    text.setTextAppearance(parent.getContext(), R.style.TextAppearance_SlidingTabActive);
			}
			...
			target.setLayoutParams(new LayoutParams(25,25));
	...
	public SlidingTab(Context context, AttributeSet attrs) {
		...
		rightSlider = new Slider(this, R.drawable.ic_jog_dial_answer, R.drawable.jog_tab_target_red, R.drawable.jog_tab_bar_right_decline, R.drawable.jog_tab_right_decline);
	}
    ...
    public void setTypeOfLock(TypeOfLock lock) {
        ...
        if(lock == TypeOfLock.CALL) {
            ...
            // To sliding tab
            /*setLeftTabDrawables(getContext().getResources().getDrawable(R.drawable.dialpad_fab),
            ...
            setRightTabDrawables(
                    getContext().getResources().getDrawable(R.drawable.dialpad_fab),
