...
public class PreferencesWrapper {
  ...
  /*  public static final String PREFMCRM_FNAME = "FNAME";*/
  //  public static final String SERVERIP = "serverIP";
		...
		private static final long serialVersionUID = 1L;
	{
		...
		put(SipConfigManager.SND_CLOCK_RATE, "0");//8000
		...
		private static final long serialVersionUID = 1L;
	{
		...
		put(SipConfigManager.KEEP_AWAKE_IN_CALL, true);
	...
	private static File getStorageFolder(Context ctxt, boolean preferCache) {
	    ...
	    if (root.canWrite()){
			File dir = new File(root.getAbsolutePath() + File.separator + CustomDistribution.getSDCardFolder(ctxt));
			if(!dir.exists()) {
				dir.mkdirs();
