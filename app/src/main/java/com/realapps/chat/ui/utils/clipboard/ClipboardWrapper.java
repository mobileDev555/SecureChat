 ...
 * 
 */
package com.realapps.chat.ui.utils.clipboard;
    ...
    public static ClipboardWrapper getInstance(Context context) {
        if(instance == null) {
            if(Compatibility.isCompatible(11)) {
                instance = new com.realapps.chat.ui.utils.clipboard.Clipboard11();
            }else {
                instance = new com.realapps.chat.ui.utils.clipboard.Clipboard1();
            }
            if(instance != null) {
