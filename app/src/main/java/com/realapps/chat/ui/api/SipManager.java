...
public final class SipManager {
     ...
     */
    public static final String PERMISSION_CONFIGURE_SIP = URLCollection.obj.PACKAGE_NAME+".android.permission.CONFIGURE_SIP";
     ...
     */
    public static final String INTENT_SIP_CONFIGURATION = URLCollection.obj.PACKAGE_NAME+".service.SipConfiguration";
    /**
     ...
     */
    public static final String INTENT_SIP_SERVICE = URLCollection.obj.PACKAGE_NAME+".service.SipService";

    public static final String INTENT_SIP_SERVICE_RESTART = URLCollection.obj.PACKAGE_NAME+".service.RestartService";
     ...
     * Expected Extras :
     * <ul>
     * <il>{@link SipProfile#FIELD_ID} as Long to choose the account to
     * activate/deactivate</il>
     * <il><i>{@link SipProfile#FIELD_ACTIVE} - optional </i> as boolean to
     * choose if should be activated or deactivated</il>
     * </ul>
     * </p>
     */
    public static final String INTENT_SIP_ACCOUNT_ACTIVATE = URLCollection.obj.PACKAGE_NAME+".accounts.activate";
    //public static final String INTENT_Mongo_Data = URLCollection.obj.PACKAGE_NAME+".senddata";
    /**
     * Scheme for csip uri.
     */
     ...
     * Provided extras :
     * <ul>
     * <il>{@link #EXTRA_CALL_INFO} a {@link SipCallSession} containing infos of
     * the call</il>
     * </ul>
     * </p>
     */
    /*
     * Sip Account Message Status
     */
    public static final String ACTION_SIP_ACCOUNT_STATUS = URLCollection.obj.PACKAGE_NAME+".account.status";
    /*
     * Contact synchronization
     */
    public static final String ACTION_CONTACT_SYNC = URLCollection.obj.PACKAGE_NAME+".contact.sync";
    /*
     * Make call from contact list
     */
    public static final String ACTION_MAKE_CALL = URLCollection.obj.PACKAGE_NAME+".phone.make_call";
    public static final String ACTION_MAKE_DIAL_CALL = URLCollection.obj.PACKAGE_NAME+".phone.dial_call";
    public static final String ACTION_MAKE_CALL_FAV = URLCollection.obj.PACKAGE_NAME+".phone.favourite.make_call";
    public static final String ACTION_MAKE_CALL_HISTORY = URLCollection.obj.PACKAGE_NAME+".phone.history.make_call";

    public static final String ACTION_CONTACT_REMOTE_SYNC = URLCollection.obj.PACKAGE_NAME+".contact.remote.sync";

    public static final String ACTION_ADD_PARTICIPENT_STOP = URLCollection.obj.PACKAGE_NAME+".add_participent_stop_activity";
    public static final String ACTION_MANAGE_CONFERENCECALL_STOP = URLCollection.obj.PACKAGE_NAME+".manage_conference_stop_activity";
    public static final String ACTION_MANAGE_CONFERENCECALL_ADD_CONTACT = URLCollection.obj.PACKAGE_NAME+".manage_conferencecall_add_contact" ;

         // Notification class FCMListener
    public static final String ACTION_CONTACT_NOTIFICATION_SYNC = URLCollection.obj.PACKAGE_NAME+".contact.notification.sync";


    public static final String ACTION_FOR_CONFERENCE_CALLERID = URLCollection.obj.PACKAGE_NAME+".conference_callerid";


    public static final String ACTION_CALL_LOG_DELETE = URLCollection.obj.PACKAGE_NAME+".call_log_delete";


    /*
     * SMS recevier action
     */
    public static final String ACTION_ADD_CONTACT = URLCollection.obj.PACKAGE_NAME+".add_contact";

    public static final String ACTION_SIP_bROADCAST = URLCollection.obj.PACKAGE_NAME+".sipconnectionbroadcast";

    //Call Log broadcast
    public static final String ACTION_CALL_LOGS_STORED = URLCollection.obj.PACKAGE_NAME+".call_logs_stored";

    public static final String ACTION_SIP_CALL_UI = URLCollection.obj.PACKAGE_NAME+".phone.action.INCALL";
    /**
     * Action launched when the status icon clicked.<br/>
     * Should raise the dialer.
     */
    public static final String ACTION_SIP_DIALER = URLCollection.obj.PACKAGE_NAME+".phone.action.DIALER";
    /**
     * Action launched when a missed call notification entry is clicked.<br/>
     * Should raise call logs list.
     */
    public static final String ACTION_SIP_CALLLOG = URLCollection.obj.PACKAGE_NAME+".phone.action.CALLLOG";
    /**
     * Action launched when a sip message notification entry is clicked.<br/>
     * Should raise the sip message list.
     */
    public static final String ACTION_SIP_MESSAGES = URLCollection.obj.PACKAGE_NAME+".phone.action.MESSAGES";
    /**
     * Action launched when user want to go in sip favorites.
     * Should raise the sip favorites view.
     */
    public static final String ACTION_SIP_FAVORITES = URLCollection.obj.PACKAGE_NAME+".phone.action.FAVORITES";
    /**
     * Action launched to enter fast settings.<br/>
     */
    public static final String ACTION_UI_PREFS_FAST = URLCollection.obj.PACKAGE_NAME+".ui.action.PREFS_FAST";
    /**
     * Action launched to enter global csipsimple settings.<br/>
     */
    public static final String ACTION_UI_PREFS_GLOBAL = URLCollection.obj.PACKAGE_NAME+".ui.action.PREFS_GLOBAL";
     ...
     * </p>
     */
    public static final String ACTION_SIP_CALL_LAUNCH = URLCollection.obj.PACKAGE_NAME+".service.CALL_LAUNCHED";
    /**
     ...
     * </p>
     */
    public static final String ACTION_SIP_CALL_CHANGED = URLCollection.obj.PACKAGE_NAME+".service.CALL_CHANGED";
    /**
     * Broadcast sent when sip account has been changed.
     * <p>
     * Provided extras :
     * <ul>
     * <il>{@link SipProfile#FIELD_ID} the long id of the account</il>
     * </ul>
     * </p>
     */
    public static final String ACTION_SIP_ACCOUNT_CHANGED = URLCollection.obj.PACKAGE_NAME+".service.ACCOUNT_CHANGED";
    /**
     ...
     * </p>
     */
    public static final String ACTION_SIP_ACCOUNT_DELETED = URLCollection.obj.PACKAGE_NAME+".service.ACCOUNT_DELETED";
    /**
     ...
     * </p>
     */
    public static final String ACTION_SIP_REGISTRATION_CHANGED = URLCollection.obj.PACKAGE_NAME+".service.REGISTRATION_CHANGED";
    /**
     * Broadcast sent when the state of device media has been changed.
     */
    public static final String ACTION_SIP_MEDIA_CHANGED = URLCollection.obj.PACKAGE_NAME+".service.MEDIA_CHANGED";
    /**
     * Broadcast sent when a ZRTP SAS
     */
    public static final String ACTION_ZRTP_SHOW_SAS = URLCollection.obj.PACKAGE_NAME+".service.SHOW_SAS";
    /**
     ...
     */
    public static final String ACTION_SIP_MESSAGE_RECEIVED = URLCollection.obj.PACKAGE_NAME+".service.MESSAGE_RECEIVED";
    /**
     ...
     * Provided extras :
     * <ul>
     * <il>{@link SipManager#EXTRA_FILE_PATH} the path to the recorded file</il>
     * <il>{@link SipManager#EXTRA_CALL_INFO} the information on the call recorded</il>
     * </ul>
     * </p>
     */
    public static final String ACTION_SIP_CALL_RECORDED = URLCollection.obj.PACKAGE_NAME+".service.CALL_RECORDED";

    // REGISTERED BROADCASTS
    /**
     * Broadcast to send when the sip service can be stopped.disconnect
     */
    public static final String ACTION_SIP_CAN_BE_STOPPED = URLCollection.obj.PACKAGE_NAME+".service.ACTION_SIP_CAN_BE_STOPPED";
    /**
     * Broadcast to send when the sip service should be restarted.
     */
    public static final String ACTION_SIP_REQUEST_RESTART = URLCollection.obj.PACKAGE_NAME+".service.ACTION_SIP_REQUEST_RESTART";
    /**
     ...
     * @see #EXTRA_OUTGOING_ACTIVITY
     */
    public static final String ACTION_OUTGOING_UNREGISTER = URLCollection.obj.PACKAGE_NAME+".service.ACTION_OUTGOING_UNREGISTER";
    /**
     ...
     * @see #EXTRA_OUTGOING_ACTIVITY
     */
    public static final String ACTION_DEFER_OUTGOING_UNREGISTER = URLCollection.obj.PACKAGE_NAME+".service.ACTION_DEFER_OUTGOING_UNREGISTER";

    // PLUGINS BROADCASTS
    /**
     * Plugin action for themes.
     */
    public static final String ACTION_GET_DRAWABLES = URLCollection.obj.PACKAGE_NAME+".themes.GET_DRAWABLES";
    /**
     ...
     * <ul>
     * <il>{@link android.content.Intent#EXTRA_SHORTCUT_ICON} with
     * {@link android.graphics.Bitmap} (mandatory) : Icon representing the call
     * handler</il>
     * <il>{@link android.content.Intent#EXTRA_TITLE} with
     * {@link String} (mandatory) : Title representing the call
     * handler</il>
     * <il>{@link android.content.Intent#EXTRA_REMOTE_INTENT_TOKEN} with
     * {@link android.app.PendingIntent} (mandatory) : The intent to fire when
     * this action is choosen</il>
     * <il>{@link android.content.Intent#EXTRA_PHONE_NUMBER} with
     ...
     * related to a GSM call.</il>
     * </ul>
     */
    public static final String ACTION_GET_PHONE_HANDLERS = URLCollection.obj.PACKAGE_NAME+".phone.action.HANDLE_CALL";
     ...
     * <ul>
     * <il>{@link #EXTRA_SIP_CALL_MIN_STATE} minimum call state for this plugin to be active. Default {@link SipCallSession.InvState#EARLY}.</il>
     * <il>{@link #EXTRA_SIP_CALL_MAX_STATE} maximum call state for this plugin to be active. Default {@link SipCallSession.InvState#CONFIRMED}.</il>
     * <il>{@link #EXTRA_SIP_CALL_CALL_WAY} bitmask flag for selecting only one way.
     *  {@link #BITMASK_IN} for incoming; 
     *  {@link #BITMASK_OUT} for outgoing.
     *  Default ({@link #BITMASK_IN} | {@link #BITMASK_OUT}) (any way).</il>
     * </ul> 
     * Receiver activity will get an extra with key {@value #EXTRA_CALL_INFO} with a {@link SipCallSession}.
     */
    public static final String ACTION_INCALL_PLUGIN = URLCollection.obj.PACKAGE_NAME+".sipcall.action.HANDLE_CALL_PLUGIN";
    
    public static final String EXTRA_SIP_CALL_MIN_STATE = URLCollection.obj.PACKAGE_NAME+".sipcall.MIN_STATE";
    public static final String EXTRA_SIP_CALL_MAX_STATE = URLCollection.obj.PACKAGE_NAME+".sipcall.MAX_STATE";
    public static final String EXTRA_SIP_CALL_CALL_WAY = URLCollection.obj.PACKAGE_NAME+".sipcall.CALL_WAY";
     ...
     * <ul>
     * <il>{@link android.content.Intent#EXTRA_PHONE_NUMBER} with
     * {@link String} (optional) : Rewritten phone number.</il>
     * </ul>
     */
    public final static String ACTION_REWRITE_NUMBER = URLCollection.obj.PACKAGE_NAME+".phone.action.REWRITE_NUMBER";
    /**
     * Plugin action for audio codec.
     */
    public static final String ACTION_GET_EXTRA_CODECS = URLCollection.obj.PACKAGE_NAME+".codecs.action.REGISTER_CODEC";
    /**
     * Plugin action for video codec.
     */
    public static final String ACTION_GET_EXTRA_VIDEO_CODECS = URLCollection.obj.PACKAGE_NAME+".codecs.action.REGISTER_VIDEO_CODEC";
    /**
     * Plugin action for video.
     */
    public static final String ACTION_GET_VIDEO_PLUGIN = URLCollection.obj.PACKAGE_NAME+".plugins.action.REGISTER_VIDEO";
    /**
     ...
     */
    public static final String AUTHORITY = URLCollection.obj.PACKAGE_NAME+".db";
    /**
     * Base content type for csipsimple objects.
     */
    public static final String BASE_DIR_TYPE = "vnd.android.cursor.dir/vnd.paycall.idial";//simple
    /**
     * Base item content type for csipsimple objects.
     */
    public static final String BASE_ITEM_TYPE = "vnd.android.cursor.item/vnd.paycall.idial";//simple


    //yashraj for paypal screen
    public static final String ACTION_PAYPAL_STATUS = URLCollection.obj.PACKAGE_NAME+".paypal_status";
    ...
    //Reconnect TC_008 & TC_009: Adding broadcast Action event
    public static final String ACTION_NETWORK_CONNECTED = URLCollection.obj.PACKAGE_NAME+".networkConnected";
    public static final String ACTION_NETWORK_DISCONNECTED = URLCollection.obj.PACKAGE_NAME+".networkDisconnected";
    ...
    /**
     * key to contains conference call info.<br/>
     * @see SipCallSession
     */
    public static final String EXTRA_CONFERENCE_CALL_SETUP = "conference_call";

    //Change password time update password
    public static final String ACTION_RESTART_SIP_BROADCAST = URLCollection.obj.PACKAGE_NAME+".restart_sip_connection";


    public static final String ACTION_FAV_DATA = URLCollection.obj.PACKAGE_NAME+".phone.fav_data";
	...
	/*public static final String LOGIN_USERNAME_VAL = "username";
	public static final String LOGIN_PASSWORD_VAL = "password";*/
