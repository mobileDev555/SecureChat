...
package com.realapps.chat.ui.utils.backup;
	...
	public static BackupWrapper getInstance(Context context) {
		if(instance == null) {
		    if(Compatibility.isCompatible(8)) {
                instance = new com.realapps.chat.ui.utils.backup.BackupUtils8();
			}else {
                instance = new com.realapps.chat.ui.utils.backup.BackupUtils3();
			}
		    if(instance != null) {
