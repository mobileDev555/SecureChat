...
import com.realapps.chat.ui.api.SipUri.ParsedSipUriInfos;
...
public class SipProfile implements Parcelable {
     ...
     * <ul>
     * <il>If set to 1, the Contact update will be done by sending
     ...
     * Contact.</il>
     * <il>If set to 2, the Contact update will be done in a single, current
     ...
     * all done in a single request.</il>
     * </ul>
     ...
     * @see #FIELD_REG_URI
     */
    public String reg_uri = "192.168.1.18";//"178.238.230.202:9000";//"192.168.1.18";
    /**
