...
public class DialpadDtmf extends FrameLayout implements OnClickListener {
	...
	public DialpadDtmf(Context context) {
        super(context);
        initLayout(context);
    }

	public DialpadDtmf(Context context, AttributeSet attrs) {
		super(context, attrs);
		initLayout(context);
	}
	...
	private void initLayout(Context context) {
        ...
        inflater.inflate(R.layout.in_call_dialpad_dtmf, this, true);
	}
