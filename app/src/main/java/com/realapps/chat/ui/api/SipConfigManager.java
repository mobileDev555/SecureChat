...
public class SipConfigManager {
     ...
     */
    public static final String AUTHORITY = URLCollection.obj.PACKAGE_NAME+".prefs";
    private static final String BASE_DIR_TYPE = "vnd.android.cursor.dir/vnd.paycall.idial";//simple
    private static final String BASE_ITEM_TYPE = "vnd.android.cursor.item/vnd.paycall.idial";//simple
