...
import com.realapps.chat.ui.utils.contacts.ContactsWrapper;
...
public class ContactsAsyncHelper extends Handler {
    ...
    public static final void updateImageViewWithContactPhotoAsync(Context context,
        ...
        updateImageViewWithContactPhotoAsync(DEFAULT_TOKEN, null, null, context,
                imageView, person, placeholderImageResource, textDrawable);
    }
    ...
    public static final void updateImageViewWithContactPhotoAsync(int token,
        ...
        if (callerInfo == null || callerInfo.contactContentUri == null) {
            defaultImage(imageView, placeholderImageResource, new_drawable);
            return;
        }
    ...
    public static void updateImageViewWithContactPhotoAsync(Context context, ImageView imageView,
            Uri photoUri, int placeholderImageResource, TextDrawable text_drawable) {
       updateImageViewWithUriAsync(context, imageView, photoUri, placeholderImageResource, EVENT_LOAD_IMAGE_URI, text_drawable);
    }
    
    public static void updateImageViewWithContactAsync(Context context, ImageView imageView,
            Uri contactUri, int placeholderImageResource, TextDrawable img) {
    ...
    private static void updateImageViewWithUriAsync(Context context, ImageView imageView,
            Uri photoUri, int placeholderImageResource, int eventType, TextDrawable text_img) {
        if (sThreadHandler == null) {
        ...
        // just update using the placeholder image in this case.
        if (photoUri == null) {
            defaultImage(imageView, placeholderImageResource, text_img);
            return;
        }
    ...
    private static void defaultImage(ImageView imageView, int placeholderImageResource,
        ...
        if(new_image== null) {
            ...
            imageView.setImageDrawable(new_image);
        }
    }
