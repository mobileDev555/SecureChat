...
package com.realapps.chat.ui.utils.accessibility;
	...
	public static AccessibilityWrapper getInstance() {
		if(instance == null) {
			if(Compatibility.isCompatible(4)) {
			    instance = new com.realapps.chat.ui.utils.accessibility.Accessibility4();
			}else {
			    instance = new com.realapps.chat.ui.utils.accessibility.Accessibility3();
			}
		}
