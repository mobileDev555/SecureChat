    ...
    public static String getDisplayedSimpleContact(CharSequence uri) {
        ...
        if (uri != null) {
            ...
            if (!TextUtils.isEmpty(parsedInfos.displayName)) {
                ...
                // Else, if available choose the username
                String new_remoteContact = parsedInfos.userName;
                if(new_remoteContact.contains("#")) {
                    String[] remContact = new_remoteContact.split("#");
                    remoteContact = remContact[1];
                }else{
                    remoteContact = new_remoteContact;
                }
            }
            return remoteContact;
        }
