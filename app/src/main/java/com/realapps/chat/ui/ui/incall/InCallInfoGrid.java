...
public class InCallInfoGrid extends FrameLayout {
    ...
    synchronized void populate() {
        ...
        System.out.println(THIS_FILE+ "Populate " + count + " children");
        ...
        /*if(count > 0) {
            ...
            if(possibleColumns <= 03in(possibleColumns, count);
            numRows = count / numColumns;
            
            System.out.println(THIS_FILE+ "Render a grid of " + numColumns + " x " + numRows);
            ...
            if(cellHeight < minRowHeight) {
                System.out.println(THIS_FILE+ "May render weird... min height not correct " + cellHeight);
            }
            if(cellHeight <= 0 || cellWidth <= 0) {
                System.out.println(THIS_FILE+ "The call grid cannot render " + cellHeight + "x" + cellWidth
                        + " for " + width + "x" + height);
        ...
        for (curIndex = 0; curIndex < mAdapter.getCount(); curIndex++) {
            ...
            if(p == null) {
                ...
                if(p == this) {
                    ...
                    System.out.println(THIS_FILE+ "Call card already attached to somebody else");
                }
            }
            ii.forceLayout();
        }
