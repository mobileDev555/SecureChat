...
public class SipMessage {
    ...
    /**
     *Table for  Currency table
     */
    public static final String CURRENCY_TABLE_NAME = "currency";
    
    public static final String FIELD_CURR_NAME = "curr_name";
    public static final String FIELD_CURR_CODE = "curr_code";
    
    /**
     *Table for  Country table
     */
